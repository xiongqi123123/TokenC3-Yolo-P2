...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/train_tokenc3_lsnet.log'),
        logging.StreamHandler()  # 同时输出到控制台
    ]
)

# 创建模型 - 使用正确的路径
model_config = '/home/qi.xiong/Improve/yolov13/ultralytics/cfg/models/v13/yolov13n_lsnet.yaml'
...
logging.info(f"Starting tokenc3_lsnet training...")
