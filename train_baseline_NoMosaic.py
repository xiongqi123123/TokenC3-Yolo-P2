...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/train_baseline.log'),
        logging.StreamHandler()  # 同时输出到控制台
    ]
)

# 创建模型 - 使用正确的路径
model_config = 'ultralytics/cfg/models/v13/yolov13n.yaml'
...
results = model.train(
    ...
    batch=64,                 # 批次大小
    imgsz=640,                 # 输入图片尺寸
    device="6,7",                # 使用的GPU设备ID（如"0"、"0,1"等）
